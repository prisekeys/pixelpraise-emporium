...
const products = [
  { img: office2019Pro, title: "Office 2019 Professional Plus – Key für 1 PC",            price: 13, original: 45,  to: "/product/office-2019-professional-plus", whop: "https://whop.com/checkout/plan_9SCu81I3Rd5Sl" },
  { img: win11Pro,      title: "Windows 11 Professional – Key für 1 PC",                  price: 13, original: 50,  to: "/product/windows-11-professional-key-1-pc", whop: "https://whop.com/checkout/plan_oDPDDAU0cg3Lf" },
  { img: office2021Pro, title: "Office 2021 Professional Plus – Key für 1 PC",            price: 15, original: 55,  to: "/product/office-2021-professional-plus", whop: "https://whop.com/checkout/plan_cXRmNGflpuN4c" },
  { img: projectPro2024, title: "Project Professional 2024 – Key für 1 PC",                price: 17, original: 120, to: "/product/project-professional-2024-key-1-pc", whop: "https://whop.com/checkout/plan_E667X7ZZLRvMj" },
  { img: visioPro2024,  title: "Visio Professional 2024 – Key für 1 PC",                  price: 17, original: 120, to: "/product/visio-professional-2024-key-1-pc", whop: "https://whop.com/checkout/plan_pcZakGTskqbmb" },
  { img: office2024Pro, title: "Office 2024 Professional Plus LTSC – Key für 1 PC",       price: 20, original: 65,  to: "/product/office-2024-professional-plus-ltsc-key-1-pc", whop: "https://whop.com/checkout/plan_FkmvpRpakB5ld" },
  { img: office2019Mac, title: "Office 2019 Home & Business für Mac – Key für 1 Mac",     price: 32, original: 120, to: "/product/office-2019-home-business-for-mac-1-mac-key", whop: "https://whop.com/checkout/plan_eDGTcPRB6DiyP" },
  { img: esetPremium,   title: "ESET Smart Security Premium – 1 Gerät | 1-Jahres-Key",    price: 32, original: 80,  to: "/product/eset-smart-security-premium-1-device-1-year-key", whop: "https://whop.com/checkout/plan_rCZIOlElFaDd2" },
  { img: office2021Mac, title: "Office 2021 Home & Business für Mac – Key für 1 Mac",     price: 38, original: 140, to: "/product/office-2021-home-business-for-mac-1-mac-key", whop: "https://whop.com/checkout/plan_Hr9I3rbmMaIij" },
  { img: m365Family,    title: "Microsoft 365 Family – 6 Nutzer | 6 TB | 1-Jahres-Key",   price: 78, original: 130, to: "/product/microsoft-365-family-6-users-6-tb-1-year-key", whop: "https://whop.com/checkout/plan_8yC2bC1nvRG4Y" },
  { img: office2024Mac, title: "Office 2024 Home & Business für Mac – Key für 1 Mac",     price: 93, original: 180, to: "/product/office-2024-home-business-for-mac-1-mac-key", whop: "https://whop.com/checkout/plan_ohtX2pZDYAK6K" },
  { img: office365Pro,  title: "Office 365 Professional Plus – 5 Geräte | 100 GB Cloud | 1 Jahr", price: 13, original: 60, to: "/product/office-365-professional-plus-5-devices-100gb-1-year-key", whop: "https://whop.com/checkout/plan_GDDIytjYJffS0" },
];
...
const heroSlides = [
  { href: "/product/windows-11-professional-key-1-pc", product: win11Pro, eyebrow: "Windows 11 Pro", title: "Originale Software.", highlight: "Unschlagbare Preise.", desc: "Lebenslange Lizenz, sofortige E-Mail-Lieferung und freundlicher Support, wann immer Sie ihn brauchen.", cta: "Windows 11 ansehen", price: 13, original: 50 },
  { href: "/product/office-2024-professional-plus-ltsc-key-1-pc", product: office2024Pro, eyebrow: "Office 2024 Pro Plus", title: "Das neueste Office.", highlight: "In Minuten aktiviert.", desc: "Word, Excel, PowerPoint und Outlook — ein Key, ein PC, für immer.", cta: "Office 2024 holen", price: 20, original: 65 },
  { href: "/product/microsoft-365-family-6-users-6-tb-1-year-key", product: m365Family, eyebrow: "Microsoft 365 Family", title: "Premium-Apps für 6.", highlight: "6 TB Cloud inklusive.", desc: "Teilen Sie Microsoft 365 mit bis zu sechs Personen — mit je 1 TB OneDrive-Speicher.", cta: "365 Family ansehen", price: 78, original: 130 },
  { href: "/product/office-2021-professional-plus", product: office2021Pro, eyebrow: "Office 2021 Pro Plus", title: "Alles Wesentliche.", highlight: "Zum Bruchteil des Preises.", desc: "Komplette Office-Suite mit lebenslanger Lizenz und sofortiger digitaler Lieferung.", cta: "Office 2021 holen", price: 15, original: 55 },
];
  ...
  return (
    <div className="min-h-screen bg-secondary/30">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { title: "Outlook 2024 – Key für 1 PC", img: outlook2024, to: "/product/outlook-2024-product-key-1-pc", whop: "https://whop.com/checkout/plan_hLUpquD3dwJkZ" },
            { title: "Access 2024 – Key für 1 PC", img: access2024, to: "/product/access-2024-product-key-1-pc", whop: "https://whop.com/checkout/plan_RY3qEBO6CBQrM" },
            { title: "PowerPoint 2024 – Key für 1 PC", img: powerpoint2024, to: "/product/powerpoint-2024-product-key-1-pc", whop: "https://whop.com/checkout/plan_Nse08h3qGlKcB" },
            { title: "Excel 2024 – Key für 1 PC", img: excel2024, to: "/product/excel-2024-product-key-1-pc", whop: "https://whop.com/checkout/plan_pOfQfJAk0xrAX" },
          ].map((p) => (
            <article key={p.title} className="rounded-2xl border border-border bg-card overflow-hidden">
              <Link to={p.to} className="block">
                <div className="relative aspect-square overflow-hidden bg-white">
