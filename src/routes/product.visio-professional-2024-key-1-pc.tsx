...
const faqs = [
  ...
  },
  {
    ...
    a: "Your Visio Professional 2024 key is delivered automatically to your email fast after a successful payment.",
  },
  {
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-14 items-start">
          ...
          <div id="buy">
            ...
            >
              ...
              <span className="text-sm text-muted-foreground">· 420+ Sold</span>
            </a>
