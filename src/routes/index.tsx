              ...
              <div className="p-3 md:p-4">
                ...
                <div className="mt-3 flex flex-col gap-2">
                  ...
                  <button
                    ...
                    className={`w-full inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium text-primary-foreground transition hover:opacity-90 ${isOffice2019 || isWin11 || isOffice2021 || isProject2024 || isVisio2024 || isOffice2024 ? "cursor-pointer" : ""}`}
                    style={{ background: "var(--gradient-primary)" }}
                  >
