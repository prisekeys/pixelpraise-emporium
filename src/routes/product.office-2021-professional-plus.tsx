...
import productImg from "@/assets/products/Office_2021_Professional_Plus_Key_1_PC.webp";
...
export const Route = createFileRoute("/product/office-2021-professional-plus")({
  head: () => ({
    meta: [
      { title: PAGE_TITLE },
      { name: "description", content: PAGE_DESC },
      {
        name: "keywords",
        content:
          "buy office 2021 pro plus key, office 2021 professional plus key cheap, office 2021 license 1 pc, cheap office 2021 key online, office 2021 product key for sale, buy office 2021 key online instant delivery, microsoft office 2021 activation key, office 2021 digital license lifetime, office 2021 word excel powerpoint outlook",
      },
              ...
              review: [
                {
                  ...
                  reviewBody: "Office 2021 Pro Plus activated immediately. Word, Excel and Outlook running great. Perfect value.",
                },
                {
                  "@type": "Review",
                  ...
                  reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
                  reviewBody: "Genuine key at a fraction of Microsoft Store price. Smooth install on Windows 11.",
                },
                {
                  "@type": "Review",
                  ...
                  reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
                  reviewBody: "Email delivery within minutes. Activation in Word took 30 seconds. Highly recommend KeyGG.",
                },
              ],
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Office 2021 Professional Plus Key", item: PAGE_URL },
              ],
            },
            {
              "@type": "FAQPage",
...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. This is a one-time purchase that gives you lifetime activation of Office 2021 Professional Plus for 1 Windows PC. No subscription, no recurring fees.",
  },
  {
  ...
  {
    q: "Which apps are included in Office 2021 Professional Plus?",
    a: "Office 2021 Professional Plus includes Word, Excel, PowerPoint, Outlook, Access, Publisher, OneNote and Microsoft Teams.",
  },
  {
    q: "Does Office 2021 Pro Plus work on Windows 10 and Windows 11?",
    a: "Yes. Office 2021 Professional Plus is fully compatible with both Windows 10 and Windows 11 (64-bit).",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 pt-4 sm:pt-6">
        <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-muted-foreground overflow-x-auto whitespace-nowrap">
          ...
          <ChevronRight className="w-3 h-3 shrink-0" />
          <span className="text-foreground font-medium">Office 2021 Professional Plus Key</span>
        </nav>
      </div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-6 sm:py-8 md:py-12">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-14 items-start">
          ...
          <div className="relative aspect-square rounded-2xl border border-border bg-white overflow-hidden">
            <img
              src={productImg}
              alt="Buy Office 2021 Professional Plus product key for 1 PC lifetime license"
          ...
          <div id="buy">
            ...
            <h1 className="font-display font-bold text-2xl sm:text-3xl md:text-4xl tracking-tight leading-tight">
              Buy Office 2021 Professional Plus Key – 1 PC
            </h1>
            ...
            >
              ...
              <span className="text-sm text-muted-foreground">· 60+ Sold</span>
            </a>
            ...
            <ul className="mt-5 space-y-2">
              {[
                ...
                "Includes Word, Excel, PowerPoint, Outlook, Access, Publisher & OneNote",
            ...
            <div className="mt-3 flex items-center gap-2 text-xs text-muted-foreground">
              ...
              Office 2021 product key emailed within minutes of purchase
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-12 border-t border-border/60">
        <div className="max-w-3xl">
          <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-6">
            Microsoft Office 2021 Professional Plus is the latest perpetual release of Office for
            Windows, built for productivity, collaboration and modern workflows. Get all the premium
            Office apps in one lifetime license.
          </p>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Microsoft Word 2021</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Microsoft Excel 2021</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Microsoft PowerPoint 2021</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Microsoft Outlook 2021</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Microsoft Access 2021</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Microsoft Publisher 2021</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Microsoft OneNote &amp; Teams</span></li>
          </ul>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>New XLOOKUP, dynamic arrays and LET functions in Excel</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Modern visual refresh with improved dark mode</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Real-time co-authoring in Word, Excel and PowerPoint</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Improved performance, stability and security</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Ideal for business, students, freelancers and home use</span></li>
          </ul>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Original 25-character Office 2021 Pro Plus license key</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Official download link for Office 2021</span></li>
          ...
          <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            <p><strong>Step 1: Download Office 2021</strong><br />Use the official Microsoft download link included in your email.</p>
            <p><strong>Step 2: Install and open any Office app</strong><br />Open Word, Excel or PowerPoint to launch the activation prompt.</p>
            <p><strong>Step 3: Enter your product key</strong><br />Paste the 25-character license key and click "Activate". Office 2021 Pro Plus will be activated for life.</p>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-12 border-t border-border/60">
        <h2 className="font-display font-bold text-xl sm:text-2xl md:text-3xl tracking-tight mb-6">
          Office 2021 Professional Plus frequently asked questions
        </h2>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-12">
        ...
        >
          <h2 className="font-display font-bold text-2xl sm:text-3xl md:text-4xl tracking-tight">
            Buy Office 2021 Professional Plus key for just ${price}
          </h2>
