...
import productImg from "@/assets/products/Office_2019_Home_Business_for_Mac_1_Mac_Key.png.asset.json";
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: PAGE_DESC },
      {
        name: "keywords",
        content:
          "buy office 2019 for mac key, office 2019 home business mac key cheap, microsoft office 2019 mac license 1 mac, cheap office 2019 mac key online, office 2019 home business for mac product key, buy office 2019 mac key online instant delivery, office 2019 mac activation key, office 2019 home business mac digital license lifetime, microsoft office for mac download key, office 2019 mac word excel powerpoint outlook, office 2019 home business mac lifetime license, buy office 2019 for mac cheap, office 2019 mac os key",
      },
              ...
              review: [
                {
                  ...
                  reviewBody: "Got Office 2019 for Mac. Easy install, all apps working perfectly. The instructions were clear and helpful. Great price!",
                },
                {
                  "@type": "Review",
                  ...
                  reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
                  reviewBody: "Key arrived instantly and activated without any issues on my MacBook Pro. Word and Excel work flawlessly on macOS.",
                },
                {
                  "@type": "Review",
                  ...
                  reviewBody: "Genuine Office 2019 Mac key at a fraction of the Apple Store price. Setup was straightforward and support was responsive.",
                },
              ],
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Office 2019 Home & Business for Mac Key", item: PAGE_URL },
              ],
            },
            {
              "@type": "FAQPage",
              mainEntity: [
                ...
                { "@type": "Question", name: "How fast will I receive my Office 2019 Mac product key?", acceptedAnswer: { "@type": "Answer", text: "Your Office 2019 Home & Business for Mac key is delivered automatically to your email within 5–10 minutes of a successful payment." } },
                ...
                { "@type": "Question", name: "What apps are included in Office 2019 Home & Business for Mac?", acceptedAnswer: { "@type": "Answer", text: "Office 2019 Home & Business for Mac includes Word, Excel, PowerPoint and Outlook — all fully optimized for macOS." } },
                { "@type": "Question", name: "Does Office 2019 for Mac work on Intel and Apple Silicon Macs?", acceptedAnswer: { "@type": "Answer", text: "Yes. Office 2019 Home & Business for Mac works on both Intel-based Macs and Apple Silicon Macs (M1, M2, M3) through Rosetta 2." } },
              ],
            },
          ],
        }),
...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. This is a one-time purchase that gives you lifetime activation of Office 2019 Home & Business for 1 Mac. No subscription, no recurring fees.",
  },
  {
    q: "How fast will I receive my Office 2019 Mac product key?",
    a: "Your Office 2019 Home & Business for Mac key is delivered automatically to your email within 5–10 minutes of a successful payment.",
  },
  {
    q: "Is the Office 2019 Mac key genuine?",
    a: "Yes. Every key is 100% genuine and activates directly on Microsoft's official licensing servers.",
  },
  {
    q: "What apps are included in Office 2019 Home & Business for Mac?",
    a: "Office 2019 Home & Business for Mac includes Word, Excel, PowerPoint and Outlook — all fully optimized for macOS.",
  },
  {
    q: "Does Office 2019 for Mac work on Intel and Apple Silicon Macs?",
    a: "Yes. Office 2019 Home & Business for Mac works on both Intel-based Macs and Apple Silicon Macs (M1, M2, M3) through Rosetta 2.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 pt-4 sm:pt-6">
        <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-muted-foreground overflow-x-auto whitespace-nowrap">
          ...
          <ChevronRight className="w-3 h-3 shrink-0" />
          <span className="text-foreground font-medium">Office 2019 Home & Business for Mac Key</span>
        </nav>
      </div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-6 sm:py-8 md:py-12">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-14 items-start">
          ...
          <div className="relative aspect-square rounded-2xl border border-border bg-white overflow-hidden">
            <img
              src={productImg.url}
              alt="Buy Microsoft Office 2019 Home & Business for Mac product key lifetime license"
          ...
          <div id="buy">
            ...
            <h1 className="font-display font-bold text-2xl sm:text-3xl md:text-4xl tracking-tight leading-tight">
              Buy Office 2019 Home & Business for Mac – Key for 1 Mac
            </h1>
            ...
            <ul className="mt-5 space-y-2">
              {[
                ...
                "Activates on 1 Mac (Intel or Apple Silicon via Rosetta 2)",
                "Word, Excel, PowerPoint & Outlook for macOS",
                "Fully compatible with macOS Monterey, Ventura, Sonoma & later",
            ...
            <div className="mt-3 flex items-center gap-2 text-xs text-muted-foreground">
              ...
              Office 2019 Mac product key emailed within minutes of purchase
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-12 border-t border-border/60">
        <div className="max-w-3xl">
          <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-6">
            Microsoft Office 2019 Home & Business for Mac is the perfect productivity suite for Mac
            users who need the essential Office applications without a subscription. It includes
            Word, Excel, PowerPoint and Outlook — all optimized for macOS with native Mac features
            like Dark Mode, Continuity Camera and Touch Bar support.
          </p>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span><strong>Supported OS:</strong> macOS 10.14 Mojave or later</span></li>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span><strong>Word 2019 for Mac</strong> — Create beautiful documents with advanced editing and formatting</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span><strong>Excel 2019 for Mac</strong> — Powerful spreadsheets, formulas, charts and data analysis</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span><strong>PowerPoint 2019 for Mac</strong> — Design stunning presentations with animations and transitions</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span><strong>Outlook 2019 for Mac</strong> — Manage emails, calendars, contacts and tasks</span></li>
          </ul>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Native macOS design with Dark Mode and Touch Bar support</span></li>
            ...
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Advanced collaboration features to work with Windows users</span></li>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Original 25-character Office 2019 Home & Business for Mac license key</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span>Official download link for Office 2019 for Mac</span></li>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span><strong>OS:</strong> macOS 10.14 Mojave or later (including macOS Sonoma)</span></li>
            <li className="flex items-start gap-2"><span className="shrink-0">•</span><span><strong>Processor:</strong> Intel or Apple Silicon Mac (M1, M2, M3 via Rosetta 2)</span></li>
          ...
          <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            <p><strong>Step 1: Download Office 2019 for Mac</strong><br />Use the official Microsoft download link included in your email.</p>
            ...
            <p><strong>Step 3: Enter your product key</strong><br />Paste the 25-character license key and click "Activate". Office 2019 Home & Business for Mac will be activated for life.</p>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-12 border-t border-border/60">
        <h2 className="font-display font-bold text-xl sm:text-2xl md:text-3xl tracking-tight mb-6">
          Office 2019 Home & Business for Mac frequently asked questions
        </h2>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-12">
        ...
        >
          <h2 className="font-display font-bold text-2xl sm:text-3xl md:text-4xl tracking-tight">
            Buy Office 2019 Home & Business for Mac key for just ${price}
          </h2>
